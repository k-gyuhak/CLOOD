...
class SVHN(VisionDataset):
    ...
    def __init__(
        ...
        np.place(self.targets, self.targets == 10, 0) # (32, 32, 3, 73257)
        self.data = np.transpose(self.data, (3, 2, 0, 1)) # (73257, 3, 32, 32)
        self.data = np.transpose(self.data, (0, 2, 3, 1)) # (73257, 32, 32, 3)
