"""
Most contents are from timm vision_transformer.py
It uses MyVisionTransformer
"""

from timm.models.vision_transformer import _logger, default_cfgs, checkpoint_filter_fn
from timm.models.helpers import build_model_with_cfg
from timm.models.registry import register_model

def _create_vision_transformer(variant, pretrained=False, default_cfg=None, **kwargs):
    if kwargs['transformer'] == 'adapter':
        from networks.my_vit import MyVisionTransformer
    elif kwargs['transformer'] == 'adapter_hat':
        from networks.my_vit_hat import MyVisionTransformer
    else:
        from timm.models.vision_transformer import VisionTransformer as MyVisionTransformer
        kwargs.pop('latent')
    kwargs.pop('transformer')
